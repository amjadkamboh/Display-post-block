...
const allPosts = wp.apiFetch({
  path: "/wp/v2/categories?taxonomy=category&per_page=100"
}).then(taxonomy => {
  postSelections.push({
...
const afterAllPosts = wp.apiFetch({
  path: "/wp/v2/posts?per_page=499"
}).then(posts => {
  jQuery.each(posts, function (key, val) {
    afterPostSelections.push({
...
const afterUsersSelect = wp.apiFetch({
...
(0,_wordpress_blocks__WEBPACK_IMPORTED_MODULE_1__.registerBlockType)('wpm-block/category-block-list', {
  title: (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_2__.__)('Blog Posts List Block'),
  // Block title.
  icon: 'list-view',
  // Block icon
  category: 'common',
  // Block category
  keywords: [(0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_2__.__)('Posts, Blog')],
  /**
   * Attributes 
   */
  attributes: {
  ...
  edit: props => {
    ...
    const pages = (0,_wordpress_data__WEBPACK_IMPORTED_MODULE_3__.useSelect)(select => select(_wordpress_core_data__WEBPACK_IMPORTED_MODULE_4__.store).getEntityRecords('postType', 'post', query), []);
    const optionSelections = [];
    optionSelections.push({
      label: "Exclude all posts.",
      value: 0
    });
    const optionSelectionsss = pages?.map(page => optionSelections.push({
      label: page.title.rendered,
      value: page.id
    }));
    return (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)("div", (0,_wordpress_block_editor__WEBPACK_IMPORTED_MODULE_8__.useBlockProps)(), (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)(InspectorControls, null, (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)(_wordpress_components__WEBPACK_IMPORTED_MODULE_6__.PanelBody, {
      ...
      class: "title-categories-wpm"
    }, (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)("span", {
      class: "labing"
    }, "Blog Posts List Block"), (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)("h2", null, " ", attributes.title, " "), (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)(_wordpress_components__WEBPACK_IMPORTED_MODULE_6__.SelectControl, {
      multiple: true,
...
/******/ 		}
/******/ 		
/******/ 		var chunkLoadingGlobal = self["webpackChunkrelated_post_display"] = self["webpackChunkrelated_post_display"] || [];
